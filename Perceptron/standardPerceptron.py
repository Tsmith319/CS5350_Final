...
def standardPerceptron(data,labels,testData,testLabels,unavailable):
	...
	while epoch != T:
		...
		trainingPredictionError += predictData(data,labels,w,1,unavailable)
		testingPredictionError += predictData(testData,testLabels,w,0,unavailable)
